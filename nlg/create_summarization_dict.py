...
def create_dict_for_summarization():
    ...
    dict_summarization['vaccine']['vaccine_general_info'] = vaccine_general_info + "Read more " + reg_url_vaccine_general
    ...
    dict_summarization['vaccine']['az_vaccine'] = az_vaccine + "Read more " + reg_url_az
    ...
    dict_summarization['vaccine']['moderna_vaccine'] = moderna_vaccine + "Read more " + reg_url_mod
    ...
    dict_summarization['vaccine']['biomtech_vaccine'] = biontech_vaccine + "Read more " + reg_url_bio
    ...
    dict_summarization['vaccine']['sinopharm_vaccine'] = sinopharm_vaccine + "Read more " + reg_url_sinopharm
    ...
    dict_summarization['vaccine']['sinovac_vaccine'] = sinovac_vaccine + "Read more " + reg_url_sinovac
    ...
    dict_summarization['covid_overview'] = covid_overview + "Read more " + reg_url_cov_overview
    ...
    dict_summarization['symptoms'] = symptoms + "Read more " + reg_url_symptome
    ...
    dict_summarization['covid-variants'] = covid_variants + "Read more " + reg_url_cov_variants
    ...
    for elems in parsed_html_QA.find_all('div', attrs={'class': 'sf-accordion__panel'}):
        ...
        dict_summarization[questions.strip()] = answers.strip() + "Read more " + reg_url_QA
